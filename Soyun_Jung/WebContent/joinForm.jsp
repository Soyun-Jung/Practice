							...
							<div class="flex-grow-1">
								<div class="subheading mb-3">
									<table>
										...
										<tr>
											<td>아이디 :</td>
											<td><input type="text" name="userId" id="userId" placeholder="15자 이내로 입력"></td>
											<td><input type="button" onclick="checkID()" value="중복확인">
										</tr>
										<tr>
											<td>비밀번호 :</td>
								...
								<input type="submit" value="회원가입"> <a href="login.jsp"><input
...
<script>
    function checkID() {
        ...
        location.href="CheckID?userId="+userId;
    }
</script>
