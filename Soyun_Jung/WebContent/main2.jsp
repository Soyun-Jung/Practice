	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top"
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="pagingList?uID=${ID}&uName=${Name}">Board</a></li>
			</ul>
		</div>
	</nav>
	<!-- Page Content-->
	<div class="container-fluid p-0">
		...
		<section class="resume-section" id="about">
			<div class="resume-section-content">
				...
				<p class="lead mb-5">소윤이의 홈페이지입니다.</p>
				<p class="lead mb-5"></p>
				<div class="social-icons">
					<a class="social-icon" href="#"><i class="fab fa-linkedin-in"></i></a>
					<a class="social-icon" href="https://github.com/Soyun-Jung"><i
						class="fab fa-github"></i></a> <a class="social-icon" href="#"><i
						class="fab fa-twitter"></i></a> <a class="social-icon" href="#"><i
		...
		<form>
			<section class="resume-section" id="board">
				<div class="resume-section-content">
							...
							<table>
								...
								<c:forEach items="${board}" var="board">
									<tr>
										...
										<td>${board.bWriter}</td>
										<td>${board.bDate}</td>
										<td><a href="boardView?bNum=${board.bNum}&uName=${Name}">조회</a></td>
										<td><a href="boardDel?bNum=${board.bNum}&uName=${Name}">삭제</a></td>
									</tr>
								</c:forEach>
					...
					<input type="button" onclick="location.href='BoardWrite.jsp?uName=${Name}&uID=${ID}'" value="글 작성">
					<button onclick="location.href='bModify?bNum=${view.bNum}&uName=${Name}'">수정하기</button>
				</div>
